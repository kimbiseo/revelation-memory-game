(() => {
  ...
  const PROGRESS_STORAGE_KEY = "revelation-memory-game:chapter-14:progress";
  const COLORS = [
    "rgb(3, 126, 219)",
    "rgb(156, 113, 219)",
    "rgb(240, 144, 187)",
  ...
  const verseChunks = [
    ["또", "내가 보니", "보라", "어린 양이", "시온산에 섰고", "그와 함께", "144000이", "섰는데", "그 이마에", "어린 양의", "이름과", "그 아버지의", "이름을", "쓴 것이", "있도다"],
    ["내가", "하늘에서 나는", "소리를 들으니", "많은", "물소리도 같고", "큰 뇌성도", "같은데", "내게 들리는", "소리는", "거문고", "타는 자들의", "그", "거문고 타는 것", "같더라"],
    ["저희가", "보좌와", "네 생물과", "장로들", "앞에서", "새 노래를", "부르니", "땅에서", "구속함을 얻은", "144000인", "밖에는", "능히", "이 노래를", "배울 자가", "없더라"],
    ...
    ["성 밖에서", "그 틀이", "밟히니", "틀에서", "피가 나서", "말굴레까지", "닿았고", "1600 스다디온에", "퍼졌더라"],
  ];
  ...
  const bgm = new Audio("/assets/audio/Revelation14BGM.mp3");
  bgm.loop = true;
  bgm.preload = "auto";
  bgm.volume = 0.22;
  ...
  function resetSentence() {
    ...
    state.displayLines = state.introVisible && state.verseIndex === 0
      ? [{ parts: [{ text: "요한계시록 14장", intro: true }] }]
      : [];
