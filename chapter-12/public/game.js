(() => {
  ...
  const PROGRESS_STORAGE_KEY = "revelation-memory-game:chapter-12:progress";
  const COLORS = [
    "rgb(3, 126, 219)",
    "rgb(156, 113, 219)",
    "rgb(240, 144, 187)",
  ...
  const verseChunks = [
    ...
    ["그 꼬리가", "하늘 별 1/3을", "끌어다가", "땅에 던지더라", "용이", "해산하려는 여자", "앞에서", "그가 해산하면", "그 아이를", "삼키고자", "하더니"],
    ["여자가", "아들을 낳으니", "이는", "장차 철장으", "로 만국을", "다스릴", "남자라", "그 아이를", "하나님 앞과", "그 보좌 앞으로", "올려가더라"],
    ["그 여자가", "광야로", "도망하매", "거기서", "1260일 동안", "저를", "양육하기 위하여", "하나님의", "예비하신 곳이", "있더라"],
    ...
    ["내가", "또 들으", "니 하늘에", "큰 음성이 있어", "가로되", "이제", "우리 하나님의", "구원과", "능력과", "나라와", "또 그의", "그리스도의", "권세가", "이루었으니", "우리", "형제들을", "참소하던 자", "곧", "우리 하나님", "앞에서", "밤낮", "참소하던 자가", "쫓겨 났고"],
  ...
  const bgm = new Audio("/assets/audio/Revelation12BGM.mp3");
  bgm.loop = true;
  bgm.preload = "auto";
  bgm.volume = 0.22;
  ...
  function resetSentence() {
    ...
    state.displayLines = state.introVisible && state.verseIndex === 0
      ? [{ parts: [{ text: "요한계시록 12장", intro: true }] }]
      : [];
