(() => {
  ...
  const PROGRESS_STORAGE_KEY = "revelation-memory-game:chapter-08:progress";
  const COLORS = [
    "rgb(3, 126, 219)",
    "rgb(156, 113, 219)",
    "rgb(240, 144, 187)",
  ...
  const verseChunks = [
    ...
    ["바다 가운데", "생명 가진", "피조물들의", "1/3이 죽고", "배들의 1/3이", "깨어지더라"],
    ["세째 천사가", "나팔을 부니", "횃불 같이", "타는", "큰 별이", "하늘에서 떨어져", "강들의 1/3과", "여러 물샘에", "떨어지니"],
    ["이 별 이름은", "쑥이라", "물들의 1/3이", "쑥이 되매", "그 물들이", "쓰게 됨을", "인하여", "많은 사람이", "죽더라"],
    ["네째 천사가", "나팔을 부니", "해 1/3과", "달 1/3과", "별들의 1/3이", "침을 받아", "그 1/3이", "어두워지니", "낮 1/3은", "비췸이 없고", "밤도", "그러하더라"],
  ...
  const bgm = new Audio("/assets/audio/Revelation8BGM.mp3");
  bgm.loop = true;
  bgm.preload = "auto";
  bgm.volume = 0.22;
  ...
  function resetSentence() {
    ...
    state.displayLines = state.introVisible && state.verseIndex === 0
      ? [{ parts: [{ text: "요한계시록 8장", intro: true }] }]
      : [];
