...
const CURRENT_CHAPTER = 8;
const AVAILABLE_CHAPTERS = new Set([1, 2, 3, 4, 5, 6, 7, 8]);
      ...
      >
        <div id="game-canvas" style={canvasStyle}>
          <img
            ...
            src="/chapter-08/assets/images/08_background.png"
            alt=""
            draggable="false"
          />
          ...
          <img
            ...
            src="/chapter-08/assets/images/background_grass.png"
            alt=""
            draggable="false"
          />
          ...
          <img
            ...
            src="/chapter-08/assets/images/top_cloud.png"
            alt=""
            draggable="false"
          />
          ...
          >
            <span className="menu-icon-crop" aria-hidden="true">
              <img src="/chapter-08/assets/images/menu_button.png" alt="" draggable="false" />
            </span>
          </button>
          ...
          <section id="menu-overlay" aria-label="게임 메뉴" aria-hidden="true">
            <img
              ...
              src="/chapter-08/assets/images/menu_panel.png"
              alt=""
              draggable="false"
            />
            <div className="menu-content" hidden={chapterSelectorOpen}>
              ...
              <button id="music-button" className="menu-toggle" type="button">
                <span className="round-icon-crop" aria-hidden="true">
                  <img src="/chapter-08/assets/images/icon_music.png" alt="" draggable="false" />
                </span>
                <span id="music-label">음악 켜짐</span>
              </button>
              <button id="sound-button" className="menu-toggle" type="button">
                <span className="round-icon-crop" aria-hidden="true">
                  <img src="/chapter-08/assets/images/icon_sound.png" alt="" draggable="false" />
                </span>
